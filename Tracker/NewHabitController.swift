...
extension NewHabitController {
    ...
    //        let newTracker = Tracker(id: UUID(), name: name.text ?? "", color: .colorSelection5, emoji: "❤️", calendar: weekdayArray, date: nil)
    //
    ...
    //            targetVC = navController.viewControllers.first(where: { $0 is ViewController })
    //        }
    //
